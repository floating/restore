...
export const icons = {
  clock: (settings = {}) => {
    return (
      <svg width='14px' height='18px' viewBox='0 0 12 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='watch' fill={settings ? settings.color : 'black'}>
    ...
    if (settings.direction === 'left') {
      return (
        <svg width='10px' height='16px' viewBox='0 0 10 16' version='1.1'>
          <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
            <g id='arrow-left' fill={settings ? settings.color : 'black'}>
      ...
      return (
        <svg width='10px' height='16px' viewBox='0 0 10 16' version='1.1'>
          <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
            <g id='arrow-right' fill={settings ? settings.color : 'black'}>
  ...
  cycle: (settings = {}) => {
    return (
      <svg width='18px' height='24px' viewBox='0 0 12 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='sync' fill={settings ? settings.color : 'black'}>
  ...
  telescope: (settings = {}) => {
    return (
      <svg width='16px' height='20px' viewBox='0 0 14 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='telescope' fill={settings ? settings.color : 'black'}>
  ...
  merge: (settings = {}) => {
    return (
      <svg width='13px' height='18px' viewBox='0 0 12 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='git-merge' fill={settings ? settings.color : 'black'}>
  ...
  radio: (settings = {}) => {
    return (
      <svg width='16px' height='16px' viewBox='0 0 16 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='radio-tower' fill={settings ? settings.color : 'black'}>
  ...
  zap: (settings = {}) => {
    return (
      <svg width='10px' height='16px' viewBox='0 0 10 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='zap' fill={settings ? settings.color : 'black'}>
  ...
  beaker: (settings = {}) => {
    return (
      <svg width='16px' height='16px' viewBox='0 0 16 16' version='1.1'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='beaker' fill={settings ? settings.color : 'black'}>
