...
export const telescope = (settings = {}) => {
  return (
    <svg width='21px' height='24px' viewBox='0 0 14 16' version='1.1'>
      <g id='Octicons' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'>
...
export default {clock, arrow, cycle, telescope, merge, radio}
