    ...
    return (
      <svg width='15px' height='17px' viewBox='0 0 14 16'>
        <g id='Octicons' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='clock' fill={settings ? settings.color : 'black'}>
  ...
  location: (settings = {}) => {
    return (
      <svg width='18' height='18' viewBox='0 0 1792 1792'>
        <path d='M1152 640q0-106-75-181t-181-75-181 75-75 181 75 181 181 75 181-75 75-181zm256 0q0 109-33 179l-364 774q-16 33-47.5 52t-67.5 19-67.5-19-46.5-52l-365-774q-33-70-33-179 0-212 150-362t362-150 362 150 150 362z' fill={settings ? settings.color : 'black'} />
      </svg>
    )
  }
}
